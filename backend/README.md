...
3. **Access the API**:
   - Server: http://134.33.240.184:8000
   - Documentation: http://134.33.240.184:8000/docs
...
```bash
curl "http://134.33.240.184:8000/tools"
```
...
```bash
curl -X POST "http://134.33.240.184:8000/batch/tools/execute" \
  -H "Content-Type: application/json" \
  -d '{
    "executions": [
      {
...
```bash
curl "http://134.33.240.184:8000/metrics/system"
```

### Add New Server Configuration

```bash
curl -X POST "http://134.33.240.184:8000/config/servers/add" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "custom_server",
    "config": {
...
```bash
curl -X POST "http://134.33.240.184:8000/files/upload" \
  -F "file=@document.pdf"
```
...
```bash
curl "http://134.33.240.184:8000/status/detailed"
```

### Reset System State

```bash
curl -X POST "http://134.33.240.184:8000/admin/reset"
```
